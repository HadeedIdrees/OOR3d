...
const Rightbar: React.FC = () => {
    ...
    return (
        <aside className="lg:w-[300px] 3xl:w-[400px] hidden sm:hidden lg:block z-10 lg:px-2 xl:px-4 sm:py-6">
            <div className="flex justify-between items-center">
                <div className="relative p-[2px] rounded-full">
                    ...
                    <div className="relative bg-blue-100 py-1 lg:px-2 xl:pl-2 xl:pr-4 rounded-full flex items-center gap-2 font-normal lg:text-[16px] xl:text-[16px] text-white">
                        <Image src="/images/dollar.svg" alt="dollar" width={36} height={36} className="lg:w-[20px] xl:w-auto" />
                        100,000
                    </div>
                    <div className="absolute lg:-right-2 xl:-right-2 top-6 cursor-pointer">
                        <Image src="/images/plus.png" alt="plus" width={27} height={26} className="lg:w-5 xl:w-6" />
                        <GoPlus className="absolute lg:top-[0.05rem] xl:top-[0.20rem] lg:left-[0.05rem] xl:left-[0.15rem] text-white text-[20px]" />
                    </div>
                </div>
                ...
                <ul className="mb-3 space-y-3 mt-[10px]">
                    {["Downloaded new mesh 1", "Downloaded new mesh 2", "Downloaded new mesh 3", "Downloaded new mesh 4"].map((item, index) => (
                        <li key={index} className="flex items-center space-x-2 text-sm">
                            ...
                            />
                            <span className="text-white-100 lg:text-xs xl:text-sm 2xl:text-sm">{item}</span>
                        </li>
                    ))}
                </ul>
